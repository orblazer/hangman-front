...
enum SiteFieldsEnum {
  ...
  siteMetadata___supportedLanguages = 'siteMetadata.supportedLanguages',
  siteMetadata___titleTemplate = 'siteMetadata.titleTemplate',
  siteMetadata___navbarTitle = 'siteMetadata.navbarTitle',
  siteMetadata___contact = 'siteMetadata.contact',
  siteMetadata___social___twitter = 'siteMetadata.social.twitter',
  siteMetadata___social___twitterAt = 'siteMetadata.social.twitterAt',
  port = 'port',
  host = 'host',
  polyfill = 'polyfill',
...
enum SitePageFieldsEnum {
  ...
  pluginCreator___pluginOptions___aliases____styles = 'pluginCreator.pluginOptions.aliases._styles',
...
enum SitePluginFieldsEnum {
  ...
  pluginOptions___aliases____styles = 'pluginOptions.aliases._styles',
...
type SiteSiteMetadata = {
  ...
  readonly navbarTitle: Maybe<Scalars['String']>;
...
type SiteSiteMetadataFilterInput = {
  ...
  readonly supportedLanguages: Maybe<StringQueryOperatorInput>;
  readonly titleTemplate: Maybe<StringQueryOperatorInput>;
  readonly navbarTitle: Maybe<StringQueryOperatorInput>;
...
type SiteSiteMetadataSocial = {
  ...
  readonly twitterAt: Maybe<Scalars['String']>;
};

type SiteSiteMetadataSocialFilterInput = {
  readonly twitter: Maybe<StringQueryOperatorInput>;
  readonly twitterAt: Maybe<StringQueryOperatorInput>;
};
...
type SiteMetaDataQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
      Pick<SiteSiteMetadata, 'siteUrl' | 'supportedLanguages' | 'title' | 'titleTemplate' | 'navbarTitle' | 'description' | 'contact'>
      & { readonly social: Maybe<Pick<SiteSiteMetadataSocial, 'twitter' | 'twitterAt'>> }
    )> }> };

type TranslationQueryVariables = Exact<{ [key: string]: never; }>;


type TranslationQuery = { readonly allTranslation: { readonly nodes: ReadonlyArray<Pick<Translation, 'lang' | 'namespace' | 'content'>> } };
