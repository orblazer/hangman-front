...
enum SiteFieldsEnum {
  ...
  siteMetadata___serverUrl = 'siteMetadata.serverUrl',
...
type SiteMetaDataQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
      Pick<SiteSiteMetadata, 'siteUrl' | 'serverUrl' | 'supportedLanguages' | 'title' | 'titleTemplate' | 'navbarTitle' | 'description' | 'contact'>
